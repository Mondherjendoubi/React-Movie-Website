...
import fetchBooks from "./Home"
 ...
 function UpcomingMovies() {
    ...
    let upcMoviesUrl = "https://api.themoviedb.org/3/movie/upcoming?api_key=291c267c5e08453f902d2059428d0d01&language=en-US&page=1&language=en-US&page=1";
    useEffect(() => {
        fetchBooks(upcMoviesUrl);
