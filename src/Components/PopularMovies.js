...
function PopularMovies() {
    ...
    let array = [];
    let popMoviesUrl = "https://api.themoviedb.org/3/movie/popular?api_key=291c267c5e08453f902d2059428d0d01&language=en-US&page=1&language=en-US&page=1";
    useEffect(() => {
        fetchBooks(popMoviesUrl);
    ...
    const fetchBooks = ((Url) => {
        console.log("entered");
        let url = 'https://api.themoviedb.org/3/movie/popular?api_key=291c267c5e08453f902d2059428d0d01&language=en-US&page=1&include_adult=false&query=angela';
        fetch(Url)
